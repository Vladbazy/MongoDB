...
// 2. ТОП статей (ДОЛЖЕН БЫТЬ ПЕРЕД /api/articles/:id!)
...
// 3. Получить список статей (с фильтрами)
app.get('/api/articles', async (req, res) => {
  try {
    ...
    if (dateTo) query.date = { ...query.date, $lte: new Date(dateTo + 'T23:59:59') };
...
// 4. Получить одну статью (ПОСЛЕ /api/articles и /api/articles/top!)
